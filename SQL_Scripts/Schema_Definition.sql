...
(
	ROLLNUM VARCHAR(40) PRIMARY KEY,
...
(
	...
	FOREIGN KEY (TEACHER_ID, TEACHER_NAME) REFERENCES TEACHER(ID, NAME_)
);
...
(
	...
	FOREIGN KEY (CLASSVENUE) REFERENCES CLASSVENUE(ID_)
);
...
ALTER TABLE STUDENT
ADD CONSTRAINT PK_constraint1
UNIQUE (ROLLNUM);

ALTER TABLE TEACHER
ADD CONSTRAINT PK_constraint2
UNIQUE (ID);

ALTER TABLE ATTENDENCE
ADD CONSTRAINT PK_constraint3
UNIQUE (ROLLNUM);

ALTER TABLE CLASSVENUE
ADD CONSTRAINT PK_constraint4
UNIQUE (ID_);

--ADDING FK CONSTRAINT

ALTER TABLE ATTENDENCE
ADD CONSTRAINT FK_constraint1
FOREIGN KEY (CLASSVENUE) REFERENCES CLASSVENUE(ID_) 
ON UPDATE CASCADE 
ON DELETE RESTRICT;

ALTER TABLE CLASSVENUE
ADD CONSTRAINT FK_constraint2
FOREIGN KEY (TEACHER_ID, TEACHER_NAME) REFERENCES TEACHER(ID, NAME_) 
ON UPDATE CASCADE 
ON DELETE RESTRICT;
